...
string(REGEX MATCH "^[0-9]+\\.[0-9]+\\.[0-9]+(\\.[0-9]+)?" _project_version "${_version}")
if(NOT _project_version)
  message(FATAL_ERROR "Invalid buildspec version '${_version}': expected a numeric prefix such as 1.0.0")
endif()
...
string(REPLACE "." ";" _version_canonical "${_project_version}")
